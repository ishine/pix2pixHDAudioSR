...
<p align='center'>
<img src="https://render.githubusercontent.com/render/math?math={X_{k}=\sum _{{n=0}}^{{2N-1}}x_{n}\cos \left[{\frac{\pi }{N}}\left(n%2B{\frac{1}{2}}%2B{\frac{N}{2}}\right)\left(k%2B{\frac{1}{2}}\right)\right]}">
</p>
