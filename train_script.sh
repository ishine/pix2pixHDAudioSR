...
python train.py --name VCTK_hifitts_G5L3_48ngf_log_time_D_3 --dataroot /root/VCTK-Corpus/train.csv --no_instance --no_vgg_loss --label_nc 0 --output_nc 2 --input_nc 2 --batchSize 64 --gpu_id 3 --nThreads 16 --mask --mask_mode mode2 --netG local --niter 30 --niter_decay 20 --fp16 --validation_split 0.01 --abs_spectro --center --explicit_encoding --n_blocks_global 5 --n_blocks_local 3 --ngf 48 --eval_freq 8000 --save_latest_freq 2000 --save_epoch_freq 20 --use_time_D --lambda_time 5