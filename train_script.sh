...
python train.py --name VCTK_hifitts_G3L2_48ngf_log_time_D_match --dataroot /root/hi_fi_tts_v0/audio.csv --no_instance --no_vgg_loss --label_nc 0 --output_nc 2 --input_nc 2 --batchSize 64 --gpu_id 2 --nThreads 16 --mask --mask_mode mode2 --netG local --niter 30 --niter_decay 20 --fp16 --validation_split 0.01 --abs_spectro --center --explicit_encoding --n_blocks_global 3 --n_blocks_local 2 --ngf 48 --eval_freq 7000 --save_latest_freq 2000 --save_epoch_freq 20 --use_time_D --lambda_time 10 --use_match_loss